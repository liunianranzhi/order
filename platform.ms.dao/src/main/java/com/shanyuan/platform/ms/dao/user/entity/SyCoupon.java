...
public class SyCoupon {
    ...
    @Override
   	public String toString() {
   		return "SyCoupon [couponId=" + couponId + ", memberId=" + memberId + ", usedTime=" + usedTime + ", couponCode="
   				+ couponCode + ", createTime=" + createTime + ", expiredTime=" + expiredTime + ", value=" + value
   				+ ", balance=" + balance + ", invId=" + invId + ", couponBatchSn=" + couponBatchSn + ", couponCreator="
   				+ couponCreator + ", creatorId=" + creatorId + ", operatorId=" + operatorId + ", startTime=" + startTime
   				+ "]";
   	}
}